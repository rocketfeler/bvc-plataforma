...
export function MarketKPIs({ bvc }: MarketKPIsProps) {
  ...
  const cards: KPICardData[] = [
    ...
    },
    {
      ...
      color: kpis.avanzan >= kpis.retroceden ? 'text-emerald-400' : 'text-red-400',
      bgColor: kpis.avanzan >= kpis.retroceden ? 'bg-emerald-500/10' : 'bg-red-500/10',
      borderColor: kpis.avanzan >= kpis.retroceden ? 'border-emerald-500/20' : 'border-red-500/20',
    },
    {
      ...
      color: kpis.indexChange >= 0 ? 'text-emerald-400' : 'text-red-400',
      bgColor: kpis.indexChange >= 0 ? 'bg-emerald-500/10' : 'bg-red-500/10',
      borderColor: kpis.indexChange >= 0 ? 'border-emerald-500/20' : 'border-red-500/20',
    },
  ];
