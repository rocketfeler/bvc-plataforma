  ...
  return (
    <div
      className={cn(
        ...
        "border-b border-[#1a1a1a] hover:bg-white/50 transition-colors"
      )}
      ...
      <div className="relative z-10 flex items-center justify-between w-full gap-3">
        ...
        <span
          className={cn(
            ...
            isBid ? 'text-emerald-600' : 'text-rose-600'
          )}
        >
        ...
        <div className="text-center">
          ...
          <span
            className={cn(
              ...
              spreadBajo ? 'text-emerald-600' : 'text-amber-600'
            )}
          >
      ...
      {mejorBid && mejorAsk && (
        <div className="mt-3 flex items-center gap-2 text-xs font-mono">
          ...
          <div className="flex-1 h-1.5 bg-white rounded-full overflow-hidden relative">
            {/* Línea central */}
            <div className="absolute inset-x-0 top-0 bottom-0 bg-slate-200" />
            {/* Indicador de spread */}
  ...
  return (
    <div className={cn("space-y-4", className)}>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        {/* VENTAS (Asks) */}
        <div className="bg-white border border-red-500/20 rounded-lg overflow-hidden">
          <ColumnHeader
            title="VENTAS"
