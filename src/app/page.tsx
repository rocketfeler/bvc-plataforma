...
import {
  ...
  CONFIG, CHART_COLORS, cn, CandlestickChart
} from '@/components';
...
export default function BloombergTerminal() {
  ...
  // Estado para modal de velas japonesas
...
function PortafolioView({ patrimonio, mounted, onRefresh, fetchWithRetry, getAuthHeaders, apiUrl }: any) {
  ...
  // Handlers para velas japonesas
  const openCandleModal = (ticker: string) => {
